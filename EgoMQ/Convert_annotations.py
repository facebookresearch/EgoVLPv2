...
#                     Load data
######################################################################################################
annotation_path = ""  # Change to your own path containing canonical annotation files
feat_path = "saved_features/EgoVLPv2"  # Change to your own path containing features of canonical videos
info_path = 'jsons/ego4d.json'
annot_path_train = 'jsons/moments_train.json'
annot_path_val = 'jsons/moments_val.json'
annot_path_test = 'jsons/moments_test_unannotated.json'
...
for video in v_annot['videos']:
    ...
    try:
        feats = torch.load(os.path.join(feat_path, clips[0]['clip_uid'] + '.pt'))
    except:
