...
if __name__ == "__main__":
    kwargs = dict(
        ...
        data_dir="/fsx/spraman3/Video_Language_Pretraining/Pre-training/EgoVLP/dataset/ego4d_chunked_multiprocessing",
        meta_dir="/fsx/spraman3/Video_Language_Pretraining/Pre-training",
